...
- [板上视觉栈已通](vlm-stack-orin.md) — llama.cpp sm_87 + Qwen3-VL-2B Q4 + vlm/ 三态省电 daemon + MCP + GUI Tab;llama-server prompt cache 默认 8GiB 必须关否则每请求涨 33MB 不收敛;改视觉先读 vlm/README
